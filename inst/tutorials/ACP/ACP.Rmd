...
quiz(
  question("¿Qué tipos de datos se pueden analizar mediante un ACP?" , 
           ...
           answer("Cuantitativos, tanto continuos como discretos",  correct = TRUE),
           submit_button = "Enviar respuesta",
           try_again_button = "Intentar de nuevo"),
  caption = " "
)
...
```{r q4}
quiz(
  question("¿Qué es la inercia ó varianza explicada?" , 
           correct = "", 
           allow_retry = TRUE,
...
quiz(
  question("¿Qué relación existe entre las variables originales y las componentes principales" , 
           correct = "", 
           allow_retry = TRUE,
           answer("Las componentes principales son modelos de regresión calculados mediante las variables originales", message = "No, pero no...intentalo de nuevo!"),
...
La siguiente representación simultanea proviene del ACP calculado sobre la base de datos USArrests el cual viene por defecto en R, las variables están dadas en tasas las cuales son Urbanpop (cantidad de población urbana), Assault (asaltos), Murder (asesinatos) y Rape (secuestros), para 50 estados de Estados Unidos.
...
ACP = dudi.pca(beer, scannf=FALSE, center = TRUE, scale = TRUE)
```
...
quiz(
  question("Sobre las variables es CORRECTO afirmar que:" , 
           ...
           answer("A medida que aumente el precio la cantidad de calorias van a disminuir", message = "Incorrecto. Intenta de nuevo!."),
...
quiz(
  question("De acuerdo al ACP es correcto afirmar que:" , 
           ...
           answer("Altos porcentajes de alcohol están relacionados con precios muy bajos", message = "Incorrecto. Intenta de nuevo!."),
...
quiz(
  question("" , 
           ...
           allow_retry = TRUE,
           answer("", correct = TRUE),
           answer("", message = "No, pero no...intentalo de nuevo!"),
           answer("", message = "Incorrecto. Intenta de nuevo!."),
           answer("", message = "No...intentalo de nuevo!"),
           submit_button = "Enviar respuesta",
           try_again_button = "Intentar de nuevo"),
  caption = " "
)
